  ...
  return (
    <>
      <section>
        ...
        <section>
          <p>
            👉 Mechanizm, ktry pozwala na wprowadzenie stanu oraz jego
            synchronizacji w komponentach funkcyjnych
          </p>
          <p>👉 100% kompatybilności wstecznej</p>
          <p>
            👉 Zawiera jeden ważny feature, na który wcześniej trzeba było
            wykonywać obejścia
          </p>
        </section>
      </section>
